...
var MSG_REPEATED_SET_OPTIONS = (options) =>
  `The setOptions() function should only be called once. The options passed to the additional call (${JSON.stringify(options)}) will be ignored.`;
var MSG_IMPORT_LIBRARY_EXISTS = (options) =>
  `The google.maps.importLibrary() function is already defined, and @googlemaps/js-api-loader will use the existing function instead of overwriting it. The options passed to setOptions (${JSON.stringify(options)}) will be ignored.`;
var MSG_TRUSTED_TYPES_POLICY_FAILED = (policyName, error) =>
...
var bootstrap = (bootstrapParams) => {
    ...
    (bootstrapPromise = new Promise(async (resolve, reject) => {
      ...
      for (bootstrapParamsKey in bootstrapParams)
        searchParams.set(
          ...
          bootstrapParams[bootstrapParamsKey],
        );
  ...
  namespace[IMPORT_API_NAME]
    ? console.warn(PRODUCT_NAME + " only loads once. Ignoring:", bootstrapParams)
    : (namespace[IMPORT_API_NAME] = (libraryName, ...args) =>
        libraries.add(libraryName) &&
        triggerBootstrap().then(() => namespace[IMPORT_API_NAME](libraryName, ...args)));
};
...
function useMapInstances() {
  ...
  const addMapInstance = (mapInstance, id = "default") => {
    setMapInstances((instances) =>
      Object.assign(Object.assign({}, instances), { [id]: mapInstance }),
    );
  };
...
function useMap3DInstances() {
  ...
  const addMap3DInstance = (map3dInstance, id = "default") => {
    setMap3DInstances((instances) =>
      Object.assign(Object.assign({}, instances), { [id]: map3dInstance }),
    );
  };
...
function useGoogleMapsApiLoader(props) {
  ...
  }, [apiKey, version, libraries, region, language, authReferrerPolicy, channel, solutionChannel]);
  const importLibraryCallback = (0, import_react.useCallback)(
    (name) =>
    ...
    (() =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (
            (_b = (_a = window.google) === null || _a === void 0 ? void 0 : _a.maps) === null ||
            _b === void 0
              ? void 0
              : _b.importLibrary
          ) {
...
function useInternalUsageAttributionIds(props) {
  return (0, import_react.useMemo)(
    () => (props.disableUsageAttribution ? null : DEFAULT_INTERNAL_USAGE_ATTRIBUTION_IDS),
...
var APIProvider = (props) => {
  const { children } = props,
    loaderProps = __rest(props, ["children"]);
  const { mapInstances, addMapInstance, removeMapInstance, clearMapInstances } = useMapInstances();
  const { map3dInstances, addMap3DInstance, removeMap3DInstance, clearMap3DInstances } =
    useMap3DInstances();
...
function useApiLoadingStatus() {
  var _a;
  return (
    ((_a = (0, import_react.useContext)(APIProviderContext)) === null || _a === void 0
      ? void 0
      : _a.status) || APILoadingStatus.NOT_LOADED
  );
}
/**
...
var AuthFailureMessage = () => {
  return import_react.createElement(
    ...
    import_react.createElement("h2", null, "Error: AuthFailure"),
    import_react.createElement(
      ...
      import_react.createElement("code", null, "APIProvider.apiKey"),
...
function useMapInstance(props, context) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    let map;
    const cachedMap =
      reuseMaps && CachedMapStack.has(cacheKey) ? CachedMapStack.pop(cacheKey) : null;
    ...
    if (reusedMap) {
      ...
      map = new google.maps.Map(
        mapDiv,
        Object.assign(
          Object.assign(Object.assign({}, mapOptions), renderingType ? { renderingType } : {}),
    ...
    if (defaultBounds) {
      const { padding } = defaultBounds,
        defBounds = __rest(defaultBounds, ["padding"]);
  ...
  }, [container, apiIsLoaded, id, props.mapId, props.renderingType, props.colorScheme]);
...
var Map$1 = (props) => {
  ...
  return import_react.createElement(
    ...
    map
      ? import_react.createElement(GoogleMapsContext.Provider, { value: contextValue }, children)
      : null,
  );
};
...
function useMapsLibrary(name) {
  ...
  return (_a = ctx === null || ctx === void 0 ? void 0 : ctx.loadedLibraries[name]) !== null &&
    _a !== void 0
    ? _a
    : null;
}
...
function isVersionGreaterEqual(major, minor) {
  var _a;
  if (
    !((_a = google === null || google === void 0 ? void 0 : google.maps) === null || _a === void 0
      ? void 0
      : _a.version)
  )
    return void 0;
...
function useAdvancedMarker(props) {
  ...
  (0, import_react.useEffect)(() => {
    if (
      !(marker === null || marker === void 0 ? void 0 : marker.content) ||
  ...
  }, [marker, clickable, onClick, onKeyDown, onKeyUp, onMouseEnter, onMouseLeave]);
...
function useAdvancedMarkerAnchoring(marker, anchorPoint, anchorLeft, anchorTop, hasChildren) {
  (0, import_react.useEffect)(() => {
    ...
    if (anchorPoint !== void 0) {
      const [x, y] =
        anchorPoint !== null && anchorPoint !== void 0
          ? anchorPoint
...
function useCircle(props) {
  ...
  const {
    ...
    destructuredOptions = __rest(props, [
      "onClick",
      "onDrag",
      "onDragStart",
      "onDragEnd",
  ...
  const circleOptions = useMemoized(
    Object.assign(Object.assign({}, destructuredOptions), {
      clickable:
        (_a = destructuredOptions.clickable) !== null && _a !== void 0 ? _a : Boolean(onClick),
      draggable:
        (_b = destructuredOptions.draggable) !== null && _b !== void 0
          ? _b
          : Boolean(onDrag || onDragStart || onDragEnd || onCenterChanged),
      editable:
        (_c = destructuredOptions.editable) !== null && _c !== void 0
          ? _c
          : Boolean(onRadiusChanged),
    }),
    deepEqual,
  );
  (0, import_react.useEffect)(() => {
    ...
    const newCircle = new google.maps.Circle(
      Object.assign(Object.assign({}, circleOptions), {
...
var InfoWindow = (props) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (headerContent)
      opts.headerContent =
        typeof headerContent === "string" ? headerContent : headerContainerRef.current;
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (anchor) {
      ...
      if (isAdvancedMarker(anchor) && anchor.content instanceof Element) {
        const anchorBcr =
          anchor === null || anchor === void 0 ? void 0 : anchor.getBoundingClientRect();
        if (anchorBcr && anchor.dataset.origin === "rgm") {
          const anchorDomContent =
            (_a = anchor.content.firstElementChild) === null || _a === void 0
              ? void 0
              : _a.firstElementChild;
          const contentBcr =
            anchorDomContent === null || anchorDomContent === void 0
              ? void 0
              : anchorDomContent.getBoundingClientRect();
          const anchorOffsetX =
            contentBcr.x - anchorBcr.x + (contentBcr.width - anchorBcr.width) / 2;
  ...
  return import_react.createElement(
    ...
    headerContainerRef.current !== null &&
      (0, import_react_dom.createPortal)(headerContent, headerContainerRef.current),
  );
};
/**
...
function usePolygon(props) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    listeners.push(
      google.maps.event.addListener(mvcPaths, "insert_at", (index) => {
        subscribeToInnerPath(mvcPaths.getAt(index));
        handlePathsChange();
      }),
    );
    listeners.push(
      google.maps.event.addListener(mvcPaths, "set_at", (index) => {
        subscribeToInnerPath(mvcPaths.getAt(index));
        handlePathsChange();
      }),
    );
...
function usePolyline(props) {
  ...
  const polylineOptions = useMemoized(
    Object.assign(Object.assign({}, destructuredOptions), {
      ...
      editable:
        (_c = destructuredOptions.editable) !== null && _c !== void 0 ? _c : Boolean(onPathChanged),
    }),
    deepEqual,
  );
  (0, import_react.useEffect)(() => {
...
function useMap3DInstance(props) {
  ...
  return [map3d, containerRef, map3dRef, cameraStateRef, !!maps3dLib && customElementReady];
}
/**
...
function useMap3DCameraParams(map3d, cameraStateRef, props) {
  ...
  const lat =
    (_a = centerLiteral === null || centerLiteral === void 0 ? void 0 : centerLiteral.lat) !==
      null && _a !== void 0
      ? _a
      : null;
  const lng =
    (_b = centerLiteral === null || centerLiteral === void 0 ? void 0 : centerLiteral.lng) !==
      null && _b !== void 0
      ? _b
      : null;
  const altitude =
    (_c = centerLiteral === null || centerLiteral === void 0 ? void 0 : centerLiteral.altitude) !==
      null && _c !== void 0
      ? _c
      : null;
  ...
  (0, import_react.useLayoutEffect)(() => {
    ...
    if (
      ...
      map3d.center = {
        ...
        altitude:
          (_a =
            altitude !== null && altitude !== void 0 ? altitude : currentState.center.altitude) !==
            null && _a !== void 0
            ? _a
            : 0,
      };
...
var Map3D = (0, import_react.forwardRef)((props, ref) => {
  ...
  const combinedStyle = (0, import_react.useMemo)(
    () => Object.assign(Object.assign({}, DEFAULT_CONTAINER_STYLE), style),
    [style],
  );
  ...
  return import_react.createElement(
    ...
    import_react.createElement(
      ...
      map3d &&
        import_react.createElement(GoogleMaps3DContext.Provider, { value: contextValue }, children),
    ),
  );
});
...
var Marker3D = (0, import_react.forwardRef)(function Marker3D(props, ref) {
  ...
  const markerRef = (0, import_react.useCallback)(
    (node) => {
      setMarker(node);
  ...
  return import_react.createElement(
    ...
    { value: contextValue },
    isInteractive
      ? import_react.createElement("gmp-marker-3d-interactive", { ref: markerRef })
      : import_react.createElement("gmp-marker-3d", { ref: markerRef }),
...
var Popover = (0, import_react.forwardRef)(function Popover(props, ref) {
  ...
  usePropBinding(
    popover,
    "positionAnchor",
    (_a = anchor !== null && anchor !== void 0 ? anchor : anchorId) !== null && _a !== void 0
      ? _a
      : position,
  );
  (0, import_react.useLayoutEffect)(() => {
  ...
  return import_react.createElement(
    ...
    headerContent && import_react.createElement("div", { slot: "header" }, headerContent),
    children,
  );
});
...
function useMarker(props) {
  const [marker, setMarker] = (0, import_react.useState)(null);
  const map = useMap();
  const { onClick, onDrag, onDragStart, onDragEnd, onMouseOver, onMouseOut } = props,
    markerOptions = __rest(props, [
      "onClick",
      "onDrag",
      "onDragStart",
      "onDragEnd",
...
function useRectangle(props) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const newRectangle = new google.maps.Rectangle(
      Object.assign(Object.assign({}, rectangleOptions), {
  ...
  useMapsEventListener(
    ...
    onBoundsChanged
      ? () => {
          onBoundsChanged(
            rectangle === null || rectangle === void 0 ? void 0 : rectangle.getBounds(),
          );
        }
      : null,
  );
