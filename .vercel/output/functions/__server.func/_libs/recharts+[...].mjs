...
import {
  C as require_isFunction,
  S as require_memoize,
  _ as require_isNaN,
  a as require_range,
  b as require_isNil,
  c as require_last,
  d as require_min,
  f as require_max,
  g as require_upperFirst,
  h as require_uniqBy,
  i as require_some,
  l as require_isEqual,
  m as require_sortBy,
  n as require_every,
  o as require_isBoolean,
  p as require_throttle,
  r as require_mapValues,
  s as require_isPlainObject,
  t as require_find,
  u as require_flatMap,
  v as require_isNumber,
  w as require_isObject,
  x as require_get,
  y as require_isString,
} from "./lodash.mjs";
...
var isSingleChildEqual = function isSingleChildEqual(nextChild, prevChild) {
  ...
  if (!(0, import_isNil.default)(nextChild) && !(0, import_isNil.default)(prevChild)) {
    var _ref = nextChild.props || {},
      ...
      nextProps = _objectWithoutProperties$15(_ref, _excluded$15);
    var _ref2 = prevChild.props || {},
      prevChildren = _ref2.children,
      prevProps = _objectWithoutProperties$15(_ref2, _excluded2$5);
...
function Surface(props) {
  var children = props.children,
    ...
    title = props.title,
    desc = props.desc,
    others = _objectWithoutProperties$14(props, _excluded$14);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  return /*#__PURE__*/ import_react.createElement(
    "svg",
    _extends$25({}, filterProps(others, true, "svg"), {
...
var Layer = /*#__PURE__*/ import_react.forwardRef(function (props, ref) {
  var children = props.children,
    className = props.className,
    others = _objectWithoutProperties$13(props, _excluded$13);
  var layerClass = clsx("recharts-layer", className);
  return /*#__PURE__*/ import_react.createElement(
    "g",
    _extends$24({ className: layerClass }, filterProps(others, true), { ref }),
    children,
  );
});
//#endregion
...
var _excluded$12 = ["type", "size", "sizeType"];
...
var Symbols = function Symbols(_ref) {
  ...
  var props = _objectSpread$31(
    _objectSpread$31({}, _objectWithoutProperties$12(_ref, _excluded$12)),
    {},
    {
      type,
      size,
    ...
    },
    {
      ...
      value: function renderItems() {
        ...
        return payload.map(function (entry, i) {
          ...
          var className = clsx(
            _defineProperty$35(
              _defineProperty$35({ "recharts-legend-item": true }, "legend-item-".concat(i), true),
              "inactive",
              entry.inactive,
            ),
          );
      ...
      },
      {
        ...
        value: function getBBoxSnapshot() {
          if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0)
            return _objectSpread$29({}, this.lastBoundingBox);
          return {
            width: 0,
            height: 0,
          };
  ...
  return _createClass$14(TooltipBoundingBox, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var outerStyle = _objectSpread$27(
          _objectSpread$27(
            {
              transition:
  ...
  return _createClass$13(Tooltip, [
    {
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ import_react.createElement(
          ...
          renderContent(
            content,
            _objectSpread$26(_objectSpread$26({}, this.props), {}, { payload: finalPayload }),
          ),
        );
      },
    },
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)(function (_ref, ref) {
  ...
  var _useState2 = _slicedToArray$8(
...
var _excluded2$4 = ["dx", "dy", "angle", "className", "breakAll"];
...
var calculateWordsByLines = function calculateWordsByLines(
  ...
  while (start <= end && iterations <= text.length - 1) {
    ...
    var _checkOverflow2 = _slicedToArray$6(checkOverflow(middle - 1), 2),
...
var Text = function Text(_ref5) {
  var _ref5$x = _ref5.x,
    ...
    props = _objectWithoutProperties$10(_ref5, _excluded$10);
  ...
  var dx = props.dx,
    ...
    className = props.className,
    breakAll = props.breakAll,
    textProps = _objectWithoutProperties$10(props, _excluded2$4);
  ...
  return /*#__PURE__*/ import_react.createElement(
    "text",
    _extends$20({}, filterProps(textProps, true), {
      x,
      y,
...
function getNiceTickValuesFn(_ref3) {
  ...
  var _getValidInterval2 = _slicedToArray$5(getValidInterval([min, max]), 2),
...
function getTickValuesFixedDomainFn(_ref7, tickCount) {
  var _ref8 = _slicedToArray$5(_ref7, 2),
    ...
    max = _ref8[1];
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var _getValidInterval6 = _slicedToArray$5(getValidInterval([min, max]), 2),
...
var getLegendProps = function getLegendProps(_ref) {
  ...
  var legendProps =
    legendDefaultProps !== void 0
      ? _objectSpread$23(_objectSpread$23({}, legendDefaultProps), legendItem.props)
      : {};
  var legendData;
    ...
    legendData = (formattedGraphicalItems || []).map(function (_ref3) {
      ...
      var itemProps =
        itemDefaultProps !== void 0
          ? _objectSpread$23(_objectSpread$23({}, itemDefaultProps), item.props)
          : {};
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem(item) {
  ...
  var defaultedProps =
    (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps
      ? _objectSpread$22(_objectSpread$22({}, item.type.defaultProps), item.props)
      : item.props;
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps =
          barItemDefaultProps !== void 0
            ? _objectSpread$22(_objectSpread$22({}, barItemDefaultProps), barItems[0].props)
            : barItems[0].props;
  ...
  if (legendProps) {
    ...
    if (
      ...
      return _objectSpread$22(
        _objectSpread$22({}, offset),
        {},
        _defineProperty$25({}, align, offset[align] + (boxWidth || 0)),
      );
    if (
      ...
      return _objectSpread$22(
        _objectSpread$22({}, offset),
        {},
        _defineProperty$25({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)),
      );
  }
  return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(
  ...
  var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function (result, item) {
    ...
    return _objectSpread$22(
      _objectSpread$22({}, result),
      {},
      _defineProperty$25({}, axisId, parentGroup),
    );
  }, {});
  return Object.keys(stackGroups).reduce(function (result, axisId) {
    ...
    if (group.hasStack)
      group.stackGroups = Object.keys(group.stackGroups).reduce(function (res, stackId) {
        ...
        return _objectSpread$22(
          _objectSpread$22({}, res),
          {},
          _defineProperty$25({}, stackId, {
            numericAxisId,
            cateAxisId,
            items: g.items,
    ...
    return _objectSpread$22(
      _objectSpread$22({}, result),
      {},
      _defineProperty$25({}, axisId, group),
    );
  }, {});
};
/**
...
var getTooltipItem = function getTooltipItem(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps
    ? _objectSpread$22(_objectSpread$22({}, graphicalItem.type.defaultProps), graphicalItem.props)
    : graphicalItem.props;
  ...
  return _objectSpread$22(
    _objectSpread$22({}, filterProps(graphicalItem, false)),
    {},
    {
      dataKey,
      unit,
...
function Label(_ref4) {
  var _ref4$offset = _ref4.offset,
    ...
    restProps = _objectWithoutProperties$8(_ref4, _excluded$8);
  ...
  return /*#__PURE__*/ import_react.createElement(
    Text,
    _extends$18({ className: clsx("recharts-label", className) }, attrs, positionAttrs, {
...
var parseLabel = function parseLabel(label, viewBox) {
  ...
  if ((0, import_isObject.default)(label))
    return /*#__PURE__*/ import_react.createElement(
      Label,
      _extends$18({ viewBox }, label, { key: "label-implicit" }),
    );
  return null;
};
var renderCallByParent$1 = function renderCallByParent(parentProps, viewBox) {
  ...
  return [parseLabel(parentProps.label, viewBox || parentViewBox)].concat(
    _toConsumableArray$3(explicitChildren),
  );
};
...
var _excluded2$3 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function LabelList(_ref) {
  ...
  var data = restProps.data,
    ...
    others = _objectWithoutProperties$7(restProps, _excluded2$3);
  ...
  return /*#__PURE__*/ import_react.createElement(
    ...
    data.map(function (entry, index) {
      ...
      return /*#__PURE__*/ import_react.createElement(
        Label,
        _extends$17({}, filterProps(entry, true), others, idProps, {
          ...
          viewBox: Label.parseViewBox(
            (0, import_isNil.default)(clockWise)
              ? entry
              : _objectSpread$19(_objectSpread$19({}, entry), {}, { clockWise }),
          ),
          key: "label-".concat(index),
          index,
        }),
...
function parseLabelList(label, data) {
  ...
  if ((0, import_isObject.default)(label))
    return /*#__PURE__*/ import_react.createElement(
      LabelList,
      _extends$17({ data }, label, { key: "labelList-implicit" }),
    );
  return null;
}
...
var Curve = function Curve(props) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    "path",
    _extends$15({}, filterProps(props, false), adaptEventHandlers(props), {
...
var Rectangle = function Rectangle(rectangleProps) {
  ...
  if (!isUpdateAnimationActive)
    return /*#__PURE__*/ import_react.createElement(
      "path",
      _extends$14({}, filterProps(props, true), {
        className: layerClass,
...
var Cross = function Cross(_ref) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    "path",
    _extends$12({}, filterProps(props, true), {
...
var Trapezoid = function Trapezoid(props) {
  ...
  if (!isUpdateAnimationActive)
    return /*#__PURE__*/ import_react.createElement(
      ...
      /*#__PURE__*/ import_react.createElement(
        "path",
        _extends$11({}, filterProps(trapezoidProps, true), {
          className: layerClass,
...
function Shape(_ref2) {
  ...
  if (/*#__PURE__*/ (0, import_react.isValidElement)(option))
    shape = /*#__PURE__*/ (0, import_react.cloneElement)(
      option,
      _objectSpread$13(_objectSpread$13({}, props), getPropsFromShapeOption(option)),
    );
...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function (res, entry) {
    return _objectSpread$12(
      _objectSpread$12({}, res),
      {},
      _defineProperty$15({}, entry + camelName, value),
    );
  }, {});
  result[name] = value;
  return result;
    ...
    [
      ...
      },
      {
        ...
        value: function handleTravellerMove(e) {
          ...
          this.setState(
            _defineProperty$14(
              _defineProperty$14({}, movingTravellerId, prevValue + delta),
              "brushMoveStartX",
              e.pageX,
            ),
            function () {
      ...
      },
      {
        ...
        value: function renderTravellerLayer(travellerX, id) {
          ...
          var travellerProps = _objectSpread$11(
            _objectSpread$11({}, filterProps(this.props, false)),
            {},
            {
              x,
              y,
...
function typeguardBarRectangleProps(_ref, props) {
  ...
  return _objectSpread$10(
    _objectSpread$10(
      _objectSpread$10(_objectSpread$10(_objectSpread$10({}, props), option), x ? { x } : {}),
      y ? { y } : {},
    ),
    {},
    {
          ...
          return (
            ...
            data.map(function (entry, i) {
              ...
              var props = _objectSpread$9(
                _objectSpread$9(_objectSpread$9({}, baseProps), entry),
                {},
                {
                  isActive,
                  option,
        ...
        value: function renderBackground() {
          ...
          return data.map(function (entry, i) {
            ...
            var props = _objectSpread$9(
              _objectSpread$9(
                _objectSpread$9(
                  _objectSpread$9(_objectSpread$9({}, rest), {}, { fill: "#eee" }, background),
                  backgroundProps,
                ),
...
_defineProperty$12(Bar, "getComposedData", function (_ref2) {
  ...
  var itemProps =
    itemDefaultProps !== void 0
      ? _objectSpread$9(_objectSpread$9({}, itemDefaultProps), item.props)
      : item.props;
  var dataKey = itemProps.dataKey,
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function (result, id) {
    ...
    var ticks = getTicksOfScale(
      scale,
      _objectSpread$8(_objectSpread$8({}, axis), {}, { realScaleType }),
    );
    if (axisType === "xAxis") {
    ...
    var finalAxis = _objectSpread$8(
      _objectSpread$8(_objectSpread$8({}, axis), ticks),
      {},
      {
        realScaleType,
        x,
...
var createLabeledScales = function createLabeledScales(options) {
  var scales = Object.keys(options).reduce(function (res, key) {
    return _objectSpread$8(
      _objectSpread$8({}, res),
      {},
      _defineProperty$11({}, key, ScaleHelper.create(options[key])),
    );
  }, {});
  return _objectSpread$8(
    _objectSpread$8({}, scales),
    {},
    {
...
var renderLine = function renderLine(option, props) {
  ...
  if (/*#__PURE__*/ import_react.isValidElement(option))
    ...
    line = /*#__PURE__*/ import_react.createElement(
      "line",
      _extends$7({}, props, { className: "recharts-reference-line-line" }),
    );
  return line;
};
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ import_react.createElement(
          ...
          ReferenceArea.renderRect(
            shape,
            _objectSpread$5(_objectSpread$5({ clipPath }, filterProps(this.props, true)), rect),
          ),
...
function getTicksEnd(sign, boundaries, getTickSize, ticks, minTickGap) {
  ...
  var _loop = function _loop(i) {
    ...
    if (i === len - 1) {
      ...
      result[i] = entry = _objectSpread$4(
        _objectSpread$4({}, entry),
        {},
...
function getTicksStart(sign, boundaries, getTickSize, ticks, minTickGap, preserveEnd) {
  ...
  if (preserveEnd) {
    ...
    result[len - 1] = tail = _objectSpread$4(
      _objectSpread$4({}, tail),
      {},
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          ...
          var props = _objectSpread$3(
            _objectSpread$3(
              _objectSpread$3({}, filterProps(this.props, false)),
        ...
        value:
          ...
          function renderTicks(ticks, fontSize, letterSpacing) {
            ...
            var finalTicks = getTicks(
              _objectSpread$3(_objectSpread$3({}, this.props), {}, { ticks }),
              fontSize,
              letterSpacing,
            );
            ...
            var tickLineProps = _objectSpread$3(
              _objectSpread$3({}, axisProps),
              {},
              { fill: "none" },
            ...
            var items = finalTicks.map(function (entry, i) {
              ...
              return /*#__PURE__*/ import_react.createElement(
                ...
                tickLine &&
                  /*#__PURE__*/ import_react.createElement(
                    "line",
                    _extends$4({}, tickLineProps, lineCoord, {
                      className: clsx(
        ...
        value: function renderTickItem(option, props, value) {
          ...
          if (/*#__PURE__*/ import_react.isValidElement(option))
            tickItem = /*#__PURE__*/ import_react.cloneElement(
              option,
              _objectSpread$3(_objectSpread$3({}, props), {}, { className: combinedClassName }),
            );
            ...
            tickItem = /*#__PURE__*/ import_react.createElement(
              Text,
              _extends$4({}, props, { className: "recharts-cartesian-axis-tick-value" }),
              value,
            );
          return tickItem;
        },
...
var defaultVerticalCoordinatesGenerator = function defaultVerticalCoordinatesGenerator(
  ...
  return getCoordinatesOfGrid(
    getTicks(
      _objectSpread$2(
        _objectSpread$2(_objectSpread$2({}, CartesianAxis.defaultProps), xAxis),
        {},
        {
...
var defaultHorizontalCoordinatesGenerator = function defaultHorizontalCoordinatesGenerator(
  ...
  return getCoordinatesOfGrid(
    getTicks(
      _objectSpread$2(
        _objectSpread$2(_objectSpread$2({}, CartesianAxis.defaultProps), yAxis),
        {},
        {
...
function CartesianGrid(props) {
  ...
  var propsIncludingDefaults = _objectSpread$2(
    _objectSpread$2({}, props),
    {},
    {
      stroke:
  ...
  return /*#__PURE__*/ import_react.createElement(
    ...
    /*#__PURE__*/ import_react.createElement(
      HorizontalGridLines,
      _extends$3({}, propsIncludingDefaults, {
        offset,
        horizontalPoints,
        xAxis,
        yAxis,
    ...
    /*#__PURE__*/ import_react.createElement(
      HorizontalStripes,
      _extends$3({}, propsIncludingDefaults, { horizontalPoints }),
    ),
    /*#__PURE__*/ import_react.createElement(
      VerticalStripes,
      _extends$3({}, propsIncludingDefaults, { verticalPoints }),
    ),
  );
}
