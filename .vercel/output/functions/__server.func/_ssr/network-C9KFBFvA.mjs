...
import { o as computeLiveStatus, x as trainRoutes } from "./ssr.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { v as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { s as useTranslation } from "./rail-DWAKK18y.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { D as Layers, I as Compass, J as Check, et as ArrowRight, k as Key, o as TrainFront } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/network-C9KFBFvA.js
...
function NetworkMap({ className = "" }) {
	...
	(0, import_react.useEffect)(() => {
		...
		async function pullPositions() {
			try {
				...
				for (const row of payload.trains) {
					if (row.lat === void 0 || row.lng === void 0) continue;
					next[row.trainNo] = {
						lat: row.lat,
						lng: row.lng,
		...
		pullPositions();
		const timer = window.setInterval(() => void pullPositions(), 8e3);
		return () => {
			cancelled = true;
	...
	const liveTrains = (0, import_react.useMemo)(() => {
		return trainRoutes.map((train) => {
			...
			const merged = overlay ? {
				...
				lat: overlay.lat,
				lng: overlay.lng,
				delay: overlay.delayMin
			} : status;
			return {
				train,
				status: merged,
				isLate: (merged.forecast?.delayMin ?? merged.delay ?? 0) > 2,
	...
	const dominantSource = (0, import_react.useMemo)(() => {
		const counts = {
			railradar: 0,
			crowd: 0,
			replay: 0
		};
		for (const row of liveTrains) if (row.source) counts[row.source] += 1;
				...
				children: viewMode === "google" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(APIProvider, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Map$1, {
						...
						children: [
							...
							filteredTrains.map(({ train, status, isLate, source }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdvancedMarker, {
								position: {
									lat: status.lat,
									lng: status.lng
								},
							...
							selectedTrain && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoWindow, {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "mt-1 font-mono text-[10px] uppercase tracking-wide text-slate-500",
											children: ["tier ", selectedTrain.source ?? "replay"]
										}),
