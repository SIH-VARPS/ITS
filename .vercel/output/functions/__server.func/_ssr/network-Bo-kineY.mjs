...
function NetworkMap({ className = "" }) {
  ...
  const routesPts = (0, import_react.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    ...
                    children: ["All (", liveTrains.length, ")"],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
          ...
          viewMode === "google"
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(APIProvider, {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Map$1, {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NetworkRoutesLayer, {
                      routes: trainRoutes,
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NetworkCameraHandler, {
                      routes: trainRoutes,
                    }),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        AdvancedMarker,
                        {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "group relative flex flex-col items-center cursor-pointer transition-transform hover:scale-125",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                className: `absolute -inset-1 rounded-full ${isLate ? "bg-amber-500/40" : "bg-primary/40"} animate-rail-pulse pointer-events-none`,
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "absolute -bottom-4 whitespace-nowrap rounded-xs bg-slate-950/85 px-1 py-0.2 text-[8px] font-mono font-bold text-white shadow-xs pointer-events-none",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoWindow, {
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              className:
                                "flex items-center justify-between gap-2 border-b border-slate-200 pb-1",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  children: selectedTrain.train.halts[0].code,
                                }),
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  children:
                                    selectedTrain.train.halts[selectedTrain.train.halts.length - 1]
                                      .code,
                                }),
                              ],
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
                                  children: selectedTrain.status.lastHalt.name,
                                }),
                                " (",
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              ...
                              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                                ...
                                className:
                                  "inline-flex items-center gap-1 text-[11px] font-bold text-blue-600 hover:underline",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                    children: "View Live GPS Tracking",
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, {
                                    className: "size-3",
                                  }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex flex-wrap items-center justify-between gap-3 border-t border-border bg-card/90 px-3 py-2 text-[10px] text-muted-foreground backdrop-blur-xs",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                children: "Real-Geography Indian Railways Network",
              }),
            ],
          }),
        ],
