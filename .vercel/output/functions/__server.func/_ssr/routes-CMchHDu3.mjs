...
import { b as stationMap, c as delayLabel, i as ROUTE_COUNT, l as delayTone, o as computeLiveStatus, u as findTrains, x as trainRoutes } from "./ssr.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { v as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { s as useTranslation } from "./rail-DWAKK18y.mjs";
import { g as useNavigate, h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { $ as ArrowUpDown, B as Clock, E as LayoutList, K as ChevronRight, M as Funnel, N as FileText, R as CodeXml, T as MapPin, b as Radar, et as ArrowRight, j as Gauge, m as Search, rt as Armchair } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { a as Networks, d as SiteFooter, f as SiteHeader, i as Features, n as Button, p as Stations, r as Faq, t as ApiBanner } from "./Sections-Cal2e0XI.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CMchHDu3.js
...
function SearchPanel() {
	...
	const [between, setBetween] = (0, import_react.useState)([]);
	(0, import_react.useEffect)(() => {
		...
		let cancelled = false;
		fetch(`/api/v1/between?from=${encodeURIComponent(origin)}&to=${encodeURIComponent(dest)}`).then((res) => res.json()).then((body) => {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 rounded-full bg-rail-live animate-rail-pulse" }), t("home.liveTrainsBadge", { count: ROUTE_COUNT.toLocaleString("en-IN") })]
								}),
