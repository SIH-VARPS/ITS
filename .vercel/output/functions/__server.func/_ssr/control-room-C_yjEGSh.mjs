...
function ControlRoomDashboard() {
  ...
  const reasonBreakdown = (0, import_react.useMemo)(() => {
    ...
    for (const { s } of statuses)
      if ((s.forecast?.delayMin ?? 0) > 2) counts[s.delayReason] = (counts[s.delayReason] ?? 0) + 1;
    return Object.keys(DELAY_REASONS)
  ...
  const rawAlerts = (0, import_react.useMemo)(
    () =>
      statuses
  ...
  const activePendingAlerts = (0, import_react.useMemo)(
    () => filteredAlerts.filter((a) => !a.isAcknowledged),
    [filteredAlerts],
  );
  const activeAckAlerts = (0, import_react.useMemo)(
    () => filteredAlerts.filter((a) => a.isAcknowledged),
    [filteredAlerts],
  );
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs text-muted-foreground shadow-xs",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                ...
                children: ["Last updated ", secondsAgo, "s ago"],
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
      ...
      !isBannerDismissed &&
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "flex items-start justify-between gap-3 rounded-2xl border border-sky-500/30 bg-sky-500/10 p-4 text-sky-950 dark:text-sky-100 shadow-sm animate-in fade-in duration-300",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "flex size-8 shrink-0 items-center justify-center rounded-xl bg-sky-500/20 text-sky-600 dark:text-sky-400",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
                          children: weatherAdvisory.zones,
                        }),
                        " zones (",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              className:
                "rounded-lg p-1 text-sky-700 hover:bg-sky-500/20 dark:text-sky-300 transition-colors cursor-pointer",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kpi, {
                icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CirclePause, {
                  className: "size-4",
                }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "rounded-xl border border-border/80 bg-secondary/30 px-3.5 py-2 text-xs text-muted-foreground flex items-center gap-2",
            children: [
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, {
                        dataKey: "count",
                        radius: [6, 6, 0, 0],
                        children: reasonBreakdown.map((r) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            Cell,
                            { fill: reasonColors[r.reason] },
                            r.reason,
                          ),
                        ),
                      }),
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip, {
                        ...
                        content: ({ active, payload }) => {
                          if (active && payload && payload.length) {
                            ...
                            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              className:
                                "rounded-xl border border-border bg-card p-2 text-xs shadow-lg",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                  ...
                                  children: ["Avg Delay: ", data.avgDelay, " min"],
                                }),
                              ],
                            });
                          }
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, {
                        dataKey: "count",
                        radius: [6, 6, 0, 0],
                        children: zoneBreakdown.map((z) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            Cell,
                            { fill: zoneColors[z.zone] ?? "#3b82f6" },
                            z.zone,
                          ),
                        ),
                      }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "flex flex-wrap items-center justify-between gap-3 border-b border-border bg-secondary/30 px-5 py-3",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className: "flex items-center gap-2",
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    className:
                      "rounded-full bg-rail-alert/15 px-2 py-0.5 font-mono text-[10px] font-bold text-rail-alert",
                    children: [activePendingAlerts.length, " Actionable"],
                  }),
                  activeAckAlerts.length > 0 &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "rounded-full bg-emerald-500/15 px-2 py-0.5 font-mono text-[10px] font-bold text-emerald-600 dark:text-emerald-400",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "flex flex-wrap items-center gap-3 border-b border-border bg-card p-3 text-xs",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    ...
                    className:
                      "w-full rounded-lg border border-border bg-secondary/30 pl-8 pr-3 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-hidden",
                  }),
                  searchQuery &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                    ...
                    className:
                      "rounded-lg border border-border bg-secondary/30 px-2 py-1.5 text-xs font-semibold text-foreground focus:border-primary focus:outline-hidden cursor-pointer",
                    children: [
          ...
          activePendingAlerts.length === 0 && activeAckAlerts.length === 0
            ...
            : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
                ...
                children: activePendingAlerts.map(({ t, s, zone }) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "li",
                    {
                      className:
                        "flex flex-wrap items-center justify-between gap-3 px-5 py-3.5 transition-colors hover:bg-secondary/20",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                              ...
                              className:
                                "flex size-7 shrink-0 items-center justify-center rounded-lg border border-border bg-card text-muted-foreground hover:border-emerald-500/50 hover:bg-emerald-500/10 hover:text-emerald-600 transition-colors cursor-pointer",
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      className:
                                        "rounded bg-secondary/80 px-1.5 py-0.2 font-mono text-[9px] font-bold text-foreground",
                                      children: zone,
                                    }),
                                  ],
                                }),
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                      ...
                                      children: [
                                        "Approaching: ",
                                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
                                          children: s.nextHalt?.code ?? "Destination",
                                        }),
                                      ],
                                    }),
                                  ],
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                ...
                                children: ["+", s.forecast?.delayMin ?? s.delay, " min"],
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EtaConfidenceBadge, {
                                confidence: s.forecast?.confidence ?? 0,
                              }),
                            ],
                          }),
                        }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  className:
                    "flex w-full items-center justify-between px-5 py-2.5 text-xs font-semibold text-muted-foreground hover:text-foreground transition-colors cursor-pointer",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className: "flex items-center gap-2",
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                          children: ["Acknowledged Alerts (", activeAckAlerts.length, ")"],
                        }),
                      ],
                    }),
                ...
                showAcknowledgedSection &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
                    ...
                    children: activeAckAlerts.map(({ t, s, zone }) =>
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        "li",
                        {
                          className:
                            "flex flex-wrap items-center justify-between gap-3 px-5 py-2.5 bg-secondary/10",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              className: "flex items-center gap-3 min-w-0 flex-1",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                                  onClick: () => toggleAcknowledge(t.number),
                                  className:
                                    "flex size-6 shrink-0 items-center justify-center rounded-md border border-emerald-500/40 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 hover:bg-amber-500/20 hover:text-amber-600 transition-colors cursor-pointer",
                                  title: "Reopen Alert",
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                        className:
                                          "text-xs font-medium line-through text-muted-foreground",
                                        children: [t.number, " ", t.name],
                                      }),
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        className:
                                          "rounded bg-secondary px-1 py-0.2 font-mono text-[8px] text-muted-foreground",
                                        children: zone,
                                      }),
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        className:
                                          "rounded-xs bg-emerald-500/10 px-1 py-0.2 text-[8px] font-bold text-emerald-600 dark:text-emerald-400 uppercase",
                                        children: "Actioned",
                                      }),
                                    ],
                                  }),
