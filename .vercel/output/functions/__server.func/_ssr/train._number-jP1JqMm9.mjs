...
import { c as delayLabel, d as fmtMinutes, l as delayTone, o as computeLiveStatus } from "./ssr.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { v as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { s as useTranslation } from "./rail-DWAKK18y.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { B as Clock, C as Navigation, D as Layers, G as ChevronUp, I as Compass, J as Check, S as Pen, T as MapPin, X as Calendar, _ as RotateCw, g as Route, h as Satellite, j as Gauge, k as Key, o as TrainFront, p as ShieldAlert, q as ChevronDown, tt as ArrowLeft, u as SlidersHorizontal, y as Radio } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { c as SheetHeader, d as SiteFooter, f as SiteHeader, l as SheetTitle, o as Sheet, s as SheetContent, u as SheetTrigger } from "./Sections-Cal2e0XI.mjs";
...
import { i as useEngineEta, n as etaBandBounds, r as formatIstClock, t as SourceTierBadge } from "./useEngineEta-DKZUWjOX.mjs";
...
import { t as Route$1 } from "./train._number-CHdRUOdK.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/train._number-jP1JqMm9.js
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: isOrigin ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								className: `block font-mono ${isIntermediate ? "text-[10px] text-muted-foreground font-medium" : "text-[11px] font-semibold"} ${isDelayed ? "text-muted-foreground line-through" : isIntermediate ? "text-muted-foreground" : "text-foreground"}`,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									className: "mt-0.5 flex flex-wrap items-center gap-1.5 text-[9.5px] text-muted-foreground",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function EtaBand({ payload, stationName }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		...
		children: [
			...
			station,
			" ",
			formatIstClock(payload.eta),
			", likely ",
			formatIstClock(band.lowerEta),
			"–",
			formatIstClock(band.upperEta)
		]
	});
}
function FeatureAttributions({ features }) {
	const top = [...features].sort((a, b) => Math.abs(b.value) - Math.abs(a.value)).slice(0, 3);
	if (top.length === 0) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		className: "mt-2 space-y-1 text-xs text-muted-foreground",
		"data-testid": "eta-attributions",
		children: top.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
			row.name,
			": ",
			row.value,
			" ",
...
function EngineEtaBlock({ payload, stationName }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-2",
		"data-testid": "engine-eta-block",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex flex-wrap items-center gap-2",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceTierBadge, { source: payload.source })
			}),
			stationName ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EtaBand, {
				payload,
				stationName
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EtaBand, { payload }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FeatureAttributions, { features: payload.features })
		]
	});
}
...
function useOnBoardGps(train, options = {}) {
	...
	const lastPostedAt = (0, import_react.useRef)(0);
	...
	const handlePosition = (0, import_react.useCallback)((pos) => {
		...
		if (minHaltDist <= 25) {
			...
			if (consent && Date.now() - lastPostedAt.current >= 2e4) {
				lastPostedAt.current = Date.now();
				fetch("/api/v2/observations", {
					method: "POST",
...
function TrainStatus() {
	...
	const [gpsConsent, setGpsConsent] = (0, import_react.useState)(false);
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									status?.forecast && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EtaConfidenceBadge, { confidence: engineEta?.confidence ?? status.forecast.confidence }),
											engineEta ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceTierBadge, { source: engineEta.source }) : null,
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-xs text-muted-foreground",
									...
									engineEta ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-4 rounded-xl border border-border bg-card px-4 py-3",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EngineEtaBlock, {
											payload: engineEta,
											stationName: dest.code
										})
									}) : null,
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										className: "mt-4 flex items-start gap-2 text-sm text-foreground",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											type: "checkbox",
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "I consent to sharing anonymous on-board GPS observations to improve arrival predictions. Location is not uploaded until this box is checked. Coordinates are stored at ~111 m precision and can be deleted below." })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										...
										onClick: () => {
											fetch(`/api/v2/observations?train=${encodeURIComponent(train.number)}`, { method: "DELETE" });
										},
										children: "Delete stored location data for this train"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
