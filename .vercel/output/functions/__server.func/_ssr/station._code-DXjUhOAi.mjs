              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    className:
                      "rounded-md border border-border bg-secondary/60 px-2.5 py-0.5 text-sm font-semibold text-muted-foreground",
                    children: code,
                  }),
                ],
              }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BoardTable, {
                ...
                icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowDownUp, {
                  className: "size-4",
                }),
                rows: arrivals,
              }),
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                className:
                                  "rounded-full border border-border bg-secondary/50 px-1.5 py-0.5 text-[10px] font-semibold",
                                children: type,
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                children: t("station.platform", { p: halt.platform }),
                              }),
                              forecast &&
                                forecast.delayMin > 2 &&
