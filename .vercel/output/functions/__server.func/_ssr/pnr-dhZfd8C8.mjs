...
var SAMPLE_PNRS = ["8421950247", "4920194821", "6730192845", "9120485721"];
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                className:
                  "inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs font-semibold text-primary",
                children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "relative flex items-center rounded-2xl border border-border bg-card p-2 shadow-float",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
                    ...
                    className:
                      "h-12 border-0 bg-transparent px-4 font-mono text-base tracking-wider shadow-none focus-visible:ring-0",
                  }),
                  ...
                  SAMPLE_PNRS.map((p) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "button",
                      {
                        ...
                        className:
                          "rounded-md border border-border bg-secondary/60 px-2 py-1 font-mono hover:bg-secondary hover:text-foreground",
                        children: p,
                      },
                      p,
                    ),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "flex flex-wrap items-center justify-between gap-4 border-b border-border bg-subtle-gradient p-6",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                            className:
                              "inline-flex items-center gap-1.5 rounded-full bg-rail-live/15 px-3 py-1 text-xs font-semibold text-rail-live",
                            children: [
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                            ...
                            children: [result.fromStation.name, " (", result.fromStation.code, ")"],
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                            className: "mt-1 text-lg font-bold",
                            children: [result.toStation.name, " (", result.toStation.code, ")"],
                          }),
                        ],
                      }),
                    ],
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "mt-4 divide-y divide-border overflow-hidden rounded-2xl border border-border",
                        children: result.passengers.map((p) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "div",
                            {
                              className:
                                "flex flex-wrap items-center justify-between gap-4 bg-card px-5 py-4 hover:bg-secondary/30 transition-colors",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                      className:
                                        "flex size-8 items-center justify-center rounded-full bg-secondary text-xs font-bold text-primary",
                                      children: ["#", p.number],
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                      children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                  ...
                                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        className:
                                          "inline-block rounded-md bg-rail-live/15 px-2.5 py-0.5 text-xs font-bold text-rail-live",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "flex flex-wrap items-center justify-between gap-4 border-t border-border bg-secondary/40 px-6 py-4",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
