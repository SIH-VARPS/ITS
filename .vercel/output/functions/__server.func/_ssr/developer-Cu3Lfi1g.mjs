      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "flex flex-col gap-4 border-b border-border pb-8 lg:flex-row lg:items-center lg:justify-between",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                    ...
                    rel: "noreferrer",
                    className:
                      "inline-flex items-center gap-2 rounded-xl border border-border bg-card px-4 py-2.5 text-sm font-semibold shadow-card transition-colors hover:bg-secondary/70",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Code, { className: "size-4" }),
                      " View OpenAPI Schema",
                    ],
                  }),
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  className:
                                    "rounded-md bg-secondary px-1.5 py-0.5 text-[10px] font-mono font-semibold",
                                  children: ep.method,
                                }),
                              ],
                            }),
                ...
                children: [
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                            className:
                              "rounded-md bg-secondary/80 px-2.5 py-1 text-xs font-mono font-bold text-primary",
                            children: [selectedEndpoint.method, " ", constructUrl()],
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
                            className:
                              "block text-xs font-semibold text-muted-foreground uppercase",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "flex h-10 w-16 items-center justify-center rounded-xl bg-secondary font-mono text-xs font-bold text-primary",
                                children: "GET",
                              }),
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              ...
                              children: Object.entries(params).map(([k, v]) =>
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                  "div",
                                  {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                        className:
                                          "w-20 shrink-0 font-mono text-xs font-semibold text-muted-foreground",
                                        children: k,
                                      }),
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
                                        value: v,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "flex items-center justify-between border-b border-border bg-subtle-gradient px-4 py-2.5",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className: "flex items-center gap-2",
                            children: [
                                ...
                                children:
                                  copiedLang === activeCodeTab
                                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
                                        className: "size-3.5 text-rail-live",
                                      })
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
                        className:
                          "overflow-x-auto p-4 font-mono text-xs leading-relaxed text-foreground bg-secondary/30",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "flex items-center justify-between border-b border-border bg-subtle-gradient px-4 py-3",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className: "flex items-center gap-2",
                            children: [
                      ...
                      responseBody
                        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
                            className:
                              "max-h-96 overflow-auto p-4 font-mono text-xs leading-relaxed text-foreground bg-secondary/20",
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
                        ...
                        : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, {
                                className: "mx-auto size-6 opacity-40 mb-2",
                              }),
                              "Click ",
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
                                children: "Run Test Request",
                              }),
                              " or ",
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
                                children: "Send",
