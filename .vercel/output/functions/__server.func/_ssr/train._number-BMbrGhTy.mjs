...
import {
  ...
  s as SheetContent,
  u as SheetTrigger,
} from "./Sections-SSZ3XXHL.mjs";
import { t as Toaster$1 } from "./sonner-DoFKumIW.mjs";
import {
  a as fmtMinutes,
  i as delayTone,
  r as delayLabel,
  t as computeLiveStatus,
} from "./ssr.mjs";
...
import {
  ...
  r as InfoWindow,
  t as APIProvider,
} from "../_libs/vis.gl__react-google-maps.mjs";
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex flex-wrap items-center justify-between gap-2 border-b border-border bg-secondary/40 px-3 py-2 text-xs",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    children: viewMode === "google" ? "Google Maps" : "Schematic Track",
                  }),
                ],
              }),
              viewMode === "google" &&
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                  ...
                  className:
                    "flex-1 rounded-lg border border-border bg-card px-2.5 py-1.5 font-mono text-xs text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-hidden",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  onClick: () => handleSaveKey(inputKey),
                  className:
                    "inline-flex items-center gap-1 rounded-lg bg-primary px-3 py-1.5 font-bold text-primary-foreground hover:bg-primary/90 transition-colors cursor-pointer",
                  children: [
          ...
          viewMode === "google"
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(APIProvider, {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Map$1, {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GoogleMapsTrackPolyline, {
                      path: pathCoords,
                    }),
                      ...
                      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        AdvancedMarker,
                        {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "group relative flex flex-col items-center cursor-pointer transition-transform hover:scale-110",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "absolute -bottom-4 whitespace-nowrap rounded-xs bg-slate-950/80 px-1 py-0.2 text-[8px] font-mono font-bold text-white shadow-xs pointer-events-none opacity-80 group-hover:opacity-100",
                                children: halt.code,
                              }),
                            ],
                          }),
                    ...
                    position &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdvancedMarker, {
                        position,
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                import_jsx_runtime.Fragment,
                                {
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      className:
                                        "absolute size-14 rounded-full border border-primary/50 bg-primary/20 animate-ping pointer-events-none",
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      className:
                                        "absolute size-10 rounded-full bg-primary/30 animate-rail-pulse pointer-events-none",
                                    }),
                                  ],
                                },
                              ),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "relative z-20 flex size-9 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-float ring-3 ring-white",
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                              className:
                                "absolute -top-7 z-30 whitespace-nowrap rounded-full bg-primary px-2 py-0.5 text-[9px] font-extrabold text-primary-foreground shadow-md ring-1 ring-white/40 flex items-center gap-1",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  className:
                                    "flex size-1.5 rounded-full bg-emerald-400 animate-pulse",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                  children: isMoving ? "RUNNING" : "HALTED",
                                }),
                              ],
                            }),
                          ],
                    ...
                    selectedHalt &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfoWindow, {
                        position: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex flex-wrap items-center justify-between gap-2 border-t border-border bg-card/90 px-3 py-2 text-[10px] text-muted-foreground backdrop-blur-xs",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                children: "Real-Geography GPS Path",
              }),
            ],
          }),
        ],
...
function TrainTrackTimeline({
      ...
      "div",
      {
        ...
        children: [
          showDayDivider &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "relative flex items-center justify-center py-2.5 bg-secondary/60 border-y border-border",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "absolute left-[72px] sm:left-[92px] inset-y-0 w-[24px] pointer-events-none",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: `absolute left-[4px] inset-y-0 w-[2.5px] ${isTopTraversed ? "bg-primary shadow-xs" : "bg-border"}`,
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: `absolute right-[4px] inset-y-0 w-[2.5px] ${isTopTraversed ? "bg-primary shadow-xs" : "bg-border"}`,
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                  className:
                    "relative z-10 inline-flex items-center gap-1 rounded-full border border-border bg-card px-3 py-0.5 text-[10px] font-bold text-primary shadow-xs",
                  children: ["DAY ", currentDay, " • TOMORROW"],
                }),
              ],
            }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "relative flex w-6 sm:w-7 shrink-0 items-center justify-center self-stretch",
                    children: [
                      !isOrigin &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className: `absolute left-[4px] top-0 bottom-1/2 w-[2.5px] ${isTopTraversed ? "bg-primary shadow-xs" : "bg-border"}`,
                        }),
                      !isDestination &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className: `absolute left-[4px] top-1/2 bottom-0 w-[2.5px] ${isBottomTraversed ? "bg-primary shadow-xs" : "bg-border"}`,
                        }),
                      !isOrigin &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className: `absolute right-[4px] top-0 bottom-1/2 w-[2.5px] ${isTopTraversed ? "bg-primary shadow-xs" : "bg-border"}`,
                        }),
                      !isDestination &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className: `absolute right-[4px] top-1/2 bottom-0 w-[2.5px] ${isBottomTraversed ? "bg-primary shadow-xs" : "bg-border"}`,
                        }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "absolute inset-y-0 left-0 right-0 flex flex-col justify-between py-1.5 pointer-events-none",
                        children: [...Array(5)].map((_, sIdx) => {
                          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "div",
                            {
                              className: `mx-auto ${isIntermediate ? "h-[1.5px] w-[14px] opacity-40" : "h-[2px] w-[18px]"} rounded-xs ${(sIdx <= 2 ? isTopTraversed : isBottomTraversed) ? "bg-primary/50" : "bg-border"}`,
                            },
                            sIdx,
                          );
                        }),
                      ...
                      isTrainHaltedHere &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "relative z-20 flex size-6 sm:size-6.5 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-xs ring-2 ring-primary/40",
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrainFront, {
                            className: "size-3.5",
                          }),
                        }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "flex flex-col justify-center min-w-0 flex-1 py-1.5 border-b border-border/30",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          isIntermediate
                            ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                className:
                                  "inline-flex items-center rounded-xs bg-secondary/80 border border-border/40 px-1 py-0.2 text-[7.5px] font-semibold text-muted-foreground uppercase tracking-wider",
                                children: "Pass",
                              })
                            : (isOrigin || isDestination) &&
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                className:
                                  "inline-flex items-center rounded-xs bg-primary/10 border border-primary/20 px-1 py-0.2 text-[8px] font-bold text-primary uppercase",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "mt-0.5 flex flex-wrap items-center gap-1.5 text-[9.5px] text-muted-foreground/80",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              import_jsx_runtime.Fragment,
                              {
                                children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                    className:
                                      "inline-flex items-center gap-0.5 rounded-md border border-border bg-secondary px-1 py-0.2 text-[8.5px] font-semibold text-secondary-foreground",
                                    children: [
                                      "PF ",
                                      row.halt.platform,
                                      " ",
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pen, {
                                        className: "size-2 opacity-50",
                                      }),
                                    ],
                                  }),
                                ],
                          ...
                          isTrainHaltedHere &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "inline-flex items-center gap-1 rounded-md bg-amber-500/15 border border-amber-500/30 px-1.5 py-0.2 text-[9px] font-bold text-amber-600 dark:text-amber-400",
                              children: "Halted at Platform",
                            }),
                          !isRowPassed &&
                            row.forecast &&
                            row.forecast.delayMin > 2 &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DelayReasonTag, {
          ...
          showEnRouteAfterThis &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "grid grid-cols-[65px_minmax(0,1fr)_65px] sm:grid-cols-[85px_minmax(0,1fr)_85px] items-stretch min-h-[56px] px-3 bg-primary/5 border-y border-primary/15",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "absolute left-[4px] top-0 bottom-1/2 w-[2.5px] bg-primary shadow-xs",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "absolute right-[4px] top-0 bottom-1/2 w-[2.5px] bg-primary shadow-xs",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          ...
                          children: [...Array(5)].map((_, sIdx) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              "div",
                              {
                                className: `mx-auto h-[2px] w-[18px] rounded-xs ${sIdx <= 2 ? "bg-primary/50" : "bg-border"}`,
                              },
                              sIdx,
                            ),
                          ),
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                            "relative z-20 flex size-6 sm:size-7 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-float ring-3 ring-primary/30",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "absolute -inset-1 rounded-full bg-primary/35 animate-rail-pulse pointer-events-none",
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "absolute -inset-2.5 rounded-full border border-primary/40 animate-ping opacity-75 pointer-events-none",
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrainFront, {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "flex flex-wrap items-center gap-1.5 rounded-xl border border-primary/25 bg-card/90 px-3 py-1.5 shadow-xs",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                            ...
                            children: ["En Route · ", status.speed, " km/h"],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex flex-wrap items-center justify-between gap-2 border-b border-border bg-subtle-gradient px-4 py-3",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className: "flex items-center gap-2",
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                ...
                children: ["(", train.number, " ", train.name, ")"],
              }),
            ],
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              train.halts.length > 7 &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      children: showAllStations ? "All Stations" : "Stops Only",
                    }),
                  ],
                }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                className:
                  "inline-flex items-center gap-1 rounded-xl border border-border bg-secondary/80 px-2.5 py-1 text-[11px] font-semibold text-secondary-foreground transition-colors hover:bg-secondary",
                children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, {
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Coach" }),
                      ],
                    }),
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
                    side: "bottom",
                    className:
                      "max-h-[85vh] rounded-t-3xl border-t border-border bg-card text-card-foreground p-6",
                    children: [
      ...
      isGpsActive &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "flex items-center justify-between gap-2 border-b border-primary/20 bg-primary/10 px-4 py-2 text-xs",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className: "flex items-center gap-2",
              children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "grid grid-cols-[65px_minmax(0,1fr)_65px] sm:grid-cols-[85px_minmax(0,1fr)_85px] items-center border-b border-border bg-secondary/30 px-3 py-2 text-center text-[10px] font-bold tracking-wider text-muted-foreground uppercase",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
              className:
                "inline-flex items-center gap-1 rounded-full border border-border bg-card px-2.5 py-0.5 text-[9px] font-semibold text-foreground shadow-xs",
        ...
        children: timelineItems.map((item) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "grid grid-cols-[65px_minmax(0,1fr)_65px] sm:grid-cols-[85px_minmax(0,1fr)_85px] items-stretch min-h-[34px] px-3 bg-secondary/15 border-b border-border/30",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {}),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className: "relative flex items-stretch gap-3 min-w-0",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className: `absolute left-[4px] inset-y-0 w-[2.5px] ${item.isPassed ? "bg-primary shadow-xs" : "bg-border"}`,
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                className: `absolute right-[4px] inset-y-0 w-[2.5px] ${item.isPassed ? "bg-primary shadow-xs" : "bg-border"}`,
                              }),
                            ],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            ...
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                              ...
                              className:
                                "inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-[10px] font-semibold text-primary hover:bg-secondary/60 transition-colors cursor-pointer",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronUp, {
                                  className: "size-3",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                  children: ["Hide ", count, " in-between stations"],
                                }),
                              ],
                            }),
                          }),
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "grid grid-cols-[65px_minmax(0,1fr)_65px] sm:grid-cols-[85px_minmax(0,1fr)_85px] items-stretch min-h-[46px] px-3 bg-secondary/30 transition-colors hover:bg-secondary/50",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className: "flex items-center justify-center text-center",
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "absolute inset-y-0 left-0 right-0 flex flex-col justify-between py-1 pointer-events-none",
                            children: [...Array(4)].map((_, sIdx) =>
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "div",
                                {
                                  className: `mx-auto h-[1.5px] w-[15px] opacity-50 rounded-xs ${item.isPassed ? "bg-primary/50" : "bg-border"}`,
                                },
                                sIdx,
                              ),
                            ),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                          onClick: () => toggleGroup(item.groupId),
                          className:
                            "flex items-center gap-1.5 rounded-lg border border-border/60 bg-card px-2.5 py-1 text-[11px] font-semibold text-foreground shadow-xs hover:border-primary/40 hover:bg-secondary/40 transition-all cursor-pointer w-full text-left truncate",
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                              ...
                              children: ["▾ ", count, " in-between stations (Click to view)"],
                            }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                              className:
                                "text-[10px] text-muted-foreground truncate hidden sm:inline",
                              children: [
                                "(",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex flex-wrap items-center justify-between gap-3 border-t border-border bg-subtle-gradient px-4 py-3",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                ...
                children:
                  status?.state === "halted"
                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                        children: ["At ", status.lastHalt.name],
                      })
                    : status?.nextHalt
                      ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                          children: [
                      ...
                      : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                          children: ["At ", train.halts[0].name],
                        }),
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    className:
                      "inline-flex items-center rounded-md bg-secondary border border-border px-1.5 py-0.2 text-[9px] font-bold text-primary uppercase tracking-wide",
                    children: isGpsActive
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    children: isGpsActive ? "In Train (GPS Active)" : "In Train?",
                  }),
                ],
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                className:
                  "flex size-7 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-xs hover:opacity-90 transition-opacity",
...
function useOnBoardGps(train) {
  ...
  const handlePosition = (0, import_react.useCallback)(
    (pos) => {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                        ...
                        children: [train.halts[0].name, " (", train.halts[0].code, ")"],
                      }),
                      " → ",
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                        to: "/station/$code",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      status?.forecast &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                            "mt-4 flex flex-wrap items-center gap-3 rounded-xl border border-border bg-secondary/40 px-4 py-3",
                          children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "absolute inset-y-0 left-0 rounded-full bg-hero-gradient transition-all duration-1000",
                            style: { width: `${status?.progress ?? 0}%` },
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "absolute top-1/2 size-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary ring-3 ring-primary/20 transition-all duration-1000",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "sticky top-20 rounded-2xl border border-border bg-card p-4 shadow-card",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className:
                            "rounded-md bg-secondary px-2 py-0.5 font-mono text-[11px] font-semibold text-primary",
