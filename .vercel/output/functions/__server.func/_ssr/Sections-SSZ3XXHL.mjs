...
import {
  ...
  i as features,
  l as useTranslation,
  n as SUPPORTED_LANGUAGES,
  o as networks,
  r as faqs,
  s as stations,
} from "./rail-bkfOfZ1j.mjs";
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "flex items-center gap-2 px-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Languages, {
              className: "size-3.5 text-primary",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              children: t("nav.selectLanguage"),
            }),
          ],
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, {
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuContent, {
        align: "end",
        className:
          "w-56 rounded-2xl p-1.5 shadow-float border-border bg-card/95 backdrop-blur-md animate-in fade-in-80 zoom-in-95 duration-150",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuLabel, {
            className:
              "flex items-center justify-between px-3 py-2 text-xs font-semibold text-muted-foreground",
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                className:
                  "text-[10px] rounded-full bg-secondary px-2 py-0.5 font-mono text-muted-foreground",
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              className:
                "flex size-9 items-center justify-center rounded-xl bg-hero-gradient text-primary-foreground shadow-float",
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LanguageSelector, {
                          variant: "mobile",
                        }),
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: features.map((f) =>
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            ...
            {
              className:
                "group rounded-2xl border border-border bg-card p-5 shadow-card transition-transform hover:-translate-y-1",
              children: [
...
function ApiBanner() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className:
        "relative overflow-hidden rounded-3xl bg-hero-gradient p-8 text-primary-foreground shadow-float sm:p-12",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "pointer-events-none absolute inset-y-0 left-0 w-24 bg-primary-foreground/10 blur-2xl animate-rail-slide",
        }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
              to: "/developer",
              className:
                "inline-flex items-center justify-center rounded-full bg-secondary px-6 py-2.5 text-sm font-semibold text-secondary-foreground shadow-xs hover:bg-secondary/90 transition-colors",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
              ...
              rel: "noreferrer",
              className:
                "inline-flex items-center gap-1.5 rounded-full border border-primary-foreground/40 bg-transparent px-6 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-primary-foreground/15 hover:text-primary-foreground transition-colors",
              children: [
      ...
      children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children: networks.map((n) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  ...
                  {
                    className:
                      "flex items-center justify-between rounded-xl border border-border bg-card px-4 py-3 text-left shadow-card transition-colors hover:border-primary/40",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className: "mt-4 grid gap-3 sm:grid-cols-2",
              children: locals.map((l) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "button",
                  {
                    className:
                      "rounded-xl border border-border bg-card px-4 py-3 text-left shadow-card transition-colors hover:border-primary/40",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        ...
                        children: t("home.servicesRunning", {
                          count: l.active.toLocaleString("en-IN"),
                        }),
                      }),
                    ],
                  },
        ...
        children: stations.map(([name, code]) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            Link,
            {
              ...
              params: { code },
              className:
                "rounded-full border border-border bg-card px-4 py-2 text-sm shadow-card transition-colors hover:border-primary/40 hover:text-primary",
              children: [
                name,
                " ",
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
          ...
          children: ["© ", /* @__PURE__ */ new Date().getFullYear(), " RailDristhi"],
        }),
      ],
    }),
  });
