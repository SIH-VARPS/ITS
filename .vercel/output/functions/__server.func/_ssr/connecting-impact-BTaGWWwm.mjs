...
function ConnectingImpactPage() {
  ...
  const handleCalculate = async (e) => {
    ...
    try {
      const data = await (
        await fetch(
          `/api/v1/connecting-impact?incoming=${encodeURIComponent(incoming)}&connecting=${encodeURIComponent(connecting)}&station=${encodeURIComponent(station)}`,
        )
      ).json();
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              children: "INCOMING SERVICE",
                            }),
                          ],
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
                          className: "mt-2 text-lg font-bold",
                          children: [result.incomingTrain.number, " ", result.incomingTrain.name],
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              children: "CONNECTING ONWARD SERVICE",
                            }),
                          ],
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "mt-4 divide-y divide-border overflow-hidden rounded-xl border border-border",
                        children: result.alternativeTrains.map((alt) =>
