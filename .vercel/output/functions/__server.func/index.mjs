...
var services = { ["ssr"]: lazyService(() => import("./_ssr/ssr.mjs").then((n) => n.v)) };
...
var _lazy_cc3VXw = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_cc3VXw
	};
	return ((_m, p) => {
		return {
			data,
