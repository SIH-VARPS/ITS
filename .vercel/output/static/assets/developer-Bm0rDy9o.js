import { Q as e, g as t, tt as n } from "./rail-1ItvYeZK.js";
import { C as r, _ as i, a, b as o, p as s, s as c, w as l } from "./Sections-C34VodZU.js";
import { t as u } from "./clock-D7B8FQ1k.js";
import { t as d } from "./input-CGjhYtgJ.js";
import { t as f } from "./sonner-BckbWgNo.js";
var p = l(`code`, [
...
function x() {
  let [e, t] = (0, v.useState)(b[1]),
    [n, l] = (0, v.useState)(b[1].path),
    [x, S] = (0, v.useState)(b[1].defaultParams || {}),
    [C, w] = (0, v.useState)(!1),
    [T, E] = (0, v.useState)(null),
    [D, O] = (0, v.useState)(null),
    [k, A] = (0, v.useState)(null),
    [j, M] = (0, v.useState)(null),
    [N, P] = (0, v.useState)(`curl`),
    F = (e) => {
      (t(e), l(e.path), S(e.defaultParams || {}), A(null), E(null), O(null));
    },
    I = () => {
      let e = new URLSearchParams();
      for (let [t, n] of Object.entries(x)) n.trim() && e.set(t, n.trim());
      let t = e.toString();
      return n + (t ? `?${t}` : ``);
    },
    L = async () => {
      ...
      try {
        let t = I(),
          n = await fetch(t),
          r = await n.json(),
          i = Math.round(performance.now() - e);
        (E(n.status), O(i), A(JSON.stringify(r, null, 2)));
      } catch (t) {
        (E(500),
          O(Math.round(performance.now() - e)),
          A(
            JSON.stringify(
              { error: !0, message: t instanceof Error ? t.message : `Fetch error` },
              null,
              2,
            ),
          ));
    ...
    R = () => {
      let e =
        typeof window < `u` ? `${window.location.origin}${I()}` : `http://localhost:3000${I()}`;
      return N === `curl`
        ? `curl -X GET "${e}" \\
...
print(data)`
    ...
    z = (e, t) => {
      (navigator.clipboard.writeText(e),
        M(t),
        i.success(`Copied ${t} snippet to clipboard`),
              ...
              (0, y.jsxs)(`div`, {
                children: [
                  (0, y.jsxs)(`span`, {
                    ...
                    children: [
                      (0, y.jsx)(o, { className: `size-3.5` }),
                      ` RailDristhi REST API v1`,
                    ],
                  }),
                  (0, y.jsx)(`h1`, {
              ...
              (0, y.jsxs)(`div`, {
                ...
                children: [
                  (0, y.jsxs)(`a`, {
                    ...
                    children: [(0, y.jsx)(p, { className: `size-4` }), ` View OpenAPI Schema`],
                  }),
                  (0, y.jsxs)(s, {
                    onClick: L,
                    className: `rounded-xl px-5 gap-2`,
                    children: [
                      (0, y.jsx)(g, { className: `size-4 fill-current` }),
                      ` Run Test Request`,
                    ],
                  }),
                ],
                  ...
                  (0, y.jsx)(`div`, {
                    ...
                    children: b.map((t) => {
                      ...
                      return (0, y.jsxs)(
                        ...
                        {
                          onClick: () => F(t),
                          className: `flex w-full flex-col gap-1 rounded-xl p-3 text-left transition-all ${n ? `bg-primary/10 border border-primary/30 text-primary shadow-xs` : `hover:bg-secondary/60 text-foreground`}`,
                          children: [
                            (0, y.jsxs)(`div`, {
                ...
                children: [
                  (0, y.jsxs)(`div`, {
                    ...
                    children: [
                          ...
                          (0, y.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, y.jsxs)(s, {
                                ...
                                children: [
                                  (0, y.jsx)(g, { className: `size-3.5 fill-current` }),
                                  C ? `Sending…` : `Send`,
                                ],
                              }),
                            ],
                      ...
                      e.defaultParams &&
                        Object.keys(e.defaultParams).length > 0 &&
                        (0, y.jsxs)(`div`, {
                          className: `mt-4`,
                          children: [
                            (0, y.jsx)(`label`, {
                                ...
                                (0, y.jsxs)(
                                  `div`,
                                  {
                                    ...
                                    children: [
                                      ...
                                      (0, y.jsx)(d, {
                                        value: t,
                                        onChange: (t) => S({ ...x, [e]: t.target.value }),
                  ...
                  (0, y.jsxs)(`div`, {
                    ...
                    children: [
                      (0, y.jsxs)(`div`, {
                        ...
                        children: [
                          (0, y.jsxs)(`div`, {
                            className: `flex items-center gap-2`,
                            children: [
                              (0, y.jsx)(_, { className: `size-4 text-primary` }),
                              (0, y.jsx)(`span`, {
                          ...
                          (0, y.jsxs)(`div`, {
                            ...
                            children: [
                              [`curl`, `js`, `python`].map((e) =>
                                (0, y.jsx)(
                                  `button`,
                                  {
                                    onClick: () => P(e),
                                    className: `rounded-lg px-2.5 py-1 text-xs font-semibold uppercase transition-colors ${N === e ? `bg-secondary text-primary font-bold` : `text-muted-foreground hover:text-foreground`}`,
                                    children: e,
                                  },
                                  e,
                                ),
                              ...
                              (0, y.jsx)(s, {
                                ...
                                children:
                                  j === N
                                    ? (0, y.jsx)(r, { className: `size-3.5 text-rail-live` })
                                    : (0, y.jsx)(m, { className: `size-3.5` }),
                              }),
                            ],
                          }),
                        ],
                      ...
                      (0, y.jsx)(`pre`, {
                        ...
                        children: (0, y.jsx)(`code`, { children: R() }),
                      }),
                    ],
                  }),
                  (0, y.jsxs)(`div`, {
                    ...
                    children: [
                      (0, y.jsxs)(`div`, {
                        ...
                        children: [
                          (0, y.jsxs)(`div`, {
                            className: `flex items-center gap-2`,
                            children: [
                              (0, y.jsx)(h, { className: `size-4 text-primary` }),
                              (0, y.jsx)(`h3`, {
                          ...
                          T !== null &&
                            (0, y.jsxs)(`div`, {
                              ...
                              children: [
                                (0, y.jsxs)(`span`, {
                                  className: `font-semibold ${T >= 200 && T < 300 ? `text-rail-live` : `text-rail-alert`}`,
                                  children: [`Status: `, T, ` `, T === 200 ? `OK` : ``],
                                }),
                                D !== null &&
                                  (0, y.jsxs)(`span`, {
                                    className: `flex items-center gap-1 text-muted-foreground`,
                                    children: [
                                      (0, y.jsx)(u, { className: `size-3` }),
                                      ` `,
                                      D,
                                      ` ms`,
                                    ],
                      ...
                      k
                        ? (0, y.jsx)(`pre`, {
                            ...
                            children: (0, y.jsx)(`code`, { children: k }),
                          })
                        : (0, y.jsxs)(`div`, {
                            className: `p-10 text-center text-sm text-muted-foreground`,
                            children: [
                              (0, y.jsx)(g, { className: `mx-auto size-6 opacity-40 mb-2` }),
                              `Click `,
                              (0, y.jsx)(`strong`, { children: `Run Test Request` }),
                              ` or `,
                              (0, y.jsx)(`strong`, { children: `Send` }),
